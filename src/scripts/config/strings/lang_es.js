...
angular
  ...
  .constant('LANG_ES', {
    ...
    new_exam_warning: 'Esta guía esta siendo usada actualmente por la organización, al crear un nuevo examen inhabilitará el acceso para su uso actual.<br><br>¿Está seguro que desea crear el examen?',
