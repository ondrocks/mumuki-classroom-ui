angular
  ...
  .constant('LANG_EN', {
    ...
    end_time: 'End time',
    evaluate: 'Evaluate',
    exam_enable_students: 'Enable students',
    exam_link: 'Exam link',
    exam_updated: 'Exam updated successfully',
    exam: 'Exam',
    exams: 'Exams',
    example: 'Example',
    exam_student_example_csv_link: 'Download an example CSV by clicking <a href="/assets/csv/exam/student-example.en.csv" download="example.csv" target="_blank">here</a>',
    ...
    no_courses_to_show: 'There are no courses to show',
    no_exams_to_show: 'There are no exams to show',
    no_guides_to_show: 'There are no guides to show',
    no_solutions_sent: 'No solutions sent',
    no_students_to_show: 'There are no students to show',
    no: 'No',
    ...
    students_added_successfully_to_exam: 'The students have been added successfully to the exam',
    students_not_added_to_exam: 'Some of the students weren\'t added to the exam',
